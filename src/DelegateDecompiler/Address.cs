...
namespace DelegateDecompiler
{
    class Address
    {
            ...
            IDictionary<Tuple<Address, Address>, Address> map)
        {
            ...
            {
                var left = address1.Expression ?? Expression.Constant(null, Processor.EnsureNullableType(address2.Type));
                var right = address2.Expression ?? Expression.Constant(null, Processor.EnsureNullableType(address1.Type));
